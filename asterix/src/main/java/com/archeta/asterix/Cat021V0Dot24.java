...
public final class Cat021V0Dot24 {
    public static final long CAT021_ID = categoryId(21, 0, 24);
    ...
    static ASTERIXCategory createCategory() {
        ...
        final DataItem i021_SP1 = DataItem.sp(CAT021_ID, 5, 11);
        final DataItem i021_SP2 = DataItem.sp(CAT021_ID, 5, 10);
