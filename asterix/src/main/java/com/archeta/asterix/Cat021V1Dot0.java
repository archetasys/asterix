...
public final class Cat021V1Dot0 {
    public static final long CAT021_ID = categoryId(21, 1, 0);
    ...
    public static final long I021_008_SP1;
    ...
    public static final long I021_040_EC7;
    public static final long I021_040_EC6;
    public static final long I021_040_EC5;
    ...
    public static final long I021_200_SP8;
    public static final long I021_200_SP7;
    public static final long I021_200_SP6;
    ...
    public static final long I021_271_X1_SP8;
    public static final long I021_271_X1_SP7;
    public static final long I021_271_X1_SP6;
    public static final long I021_271_X1_SP5;
    ...
    static {
        ...
        I021_008_SP1 = bitsFieldId(I021_008, 1, BITS_FIELD_ENCODING_SPARE);
        ...
        I021_040_EC7 = bitsFieldId(I021_040_X2, 8, BITS_FIELD_ENCODING_VALUE);
        I021_040_EC6 = bitsFieldId(I021_040_X2, 7, BITS_FIELD_ENCODING_VALUE);
        I021_040_EC5 = bitsFieldId(I021_040_X2, 6, BITS_FIELD_ENCODING_VALUE);
        ...
        I021_200_SP8 = bitsFieldId(I021_200, 8, BITS_FIELD_ENCODING_SPARE);
        I021_200_SP7 = bitsFieldId(I021_200, 7, BITS_FIELD_ENCODING_SPARE);
        I021_200_SP6 = bitsFieldId(I021_200, 6, BITS_FIELD_ENCODING_SPARE);
        ...
        I021_271_X1_SP8 = bitsFieldId(I021_271_X1, 8, BITS_FIELD_ENCODING_SPARE);
        I021_271_X1_SP7 = bitsFieldId(I021_271_X1, 7, BITS_FIELD_ENCODING_SPARE);
        I021_271_X1_SP6 = bitsFieldId(I021_271_X1, 6, BITS_FIELD_ENCODING_SPARE);
        I021_271_X1_SP5 = bitsFieldId(I021_271_X1, 5, BITS_FIELD_ENCODING_SPARE);
        I021_271_LW = bitsFieldId(I021_271_X1, 4, BITS_FIELD_ENCODING_UNSIGNED);
    ...
    static ASTERIXCategory createCategory() {
        final DataFormat f021_008 = fixed(I021_008, 1,
                ...
                spare(I021_008_SP1, position(1, 1, 1)));
        ...
        final DataFormat f021_040 = extended(I021_040,
                ...
                Part.of(I021_040_X2, 1,
                        bit(I021_040_EC7, position(1, 8, 8), "EC7", "Error Condition 7",
                                BitsValue.of(0, "Error Condition 7 not existing"),
                                BitsValue.of(1, "Error Condition 7 existing")),
                        bit(I021_040_EC6, position(1, 7, 7), "EC6", "Error Condition 6",
                                BitsValue.of(0, "Error Condition 6 not existing"),
                                BitsValue.of(1, "Error Condition 6 existing")),
                        bit(I021_040_EC5, position(1, 6, 6), "EC5", "Error Condition 5",
                                BitsValue.of(0, "Error Condition 5 not existing"),
                                BitsValue.of(1, "Error Condition 5 existing")),
        ...
        final DataFormat f021_200 = fixed(I021_200, 1,
                spare(I021_200_SP8, position(1, 8, 8)),
                spare(I021_200_SP7, position(1, 7, 7)),
                spare(I021_200_SP6, position(1, 6, 6)),
        ...
        final DataFormat f021_271 = extended(I021_271,
                ...
                Part.of(I021_271_X1, 1,
                        spare(I021_271_X1_SP8, position(1, 8, 8)),
                        spare(I021_271_X1_SP7, position(1, 7, 7)),
                        spare(I021_271_X1_SP6, position(1, 6, 6)),
                        spare(I021_271_X1_SP5, position(1, 5, 5)),
                        unsigned(I021_271_LW, position(1, 4, 2), "LW", "Length and width of aircraft"),
        ...
        final DataFormat f021_295 = compound(I021_295,
                Subfield.of(f021_295_AOS, 1, "AOS", "Aircraft Operational Status age"),
                Subfield.of(f021_295_TRD, 2, "TRD", "Target Report Descriptor age"),
                Subfield.of(f021_295_M3A, 3, "M3A", "Mode-3/A Code age"),
                Subfield.of(f021_295_QI, 4, "QI", "Quality Indicators age"),
                Subfield.of(f021_295_TI, 5, "TI", "Trajectory Intent age"),
                Subfield.of(f021_295_MAM, 6, "MAM", "Message Amplitude age"),
                Subfield.of(f021_295_GH, 7, "GH", "Geometric Height age"),
                Subfield.fx(I021_295_FX1),
                Subfield.of(f021_295_FL, 8, "FL", "Flight Level age"),
                Subfield.of(f021_295_ISA, 9, "ISA", "Intermediate State Selected Altitude age"),
                Subfield.of(f021_295_FSA, 10, "FSA", "Final State Selected Altitude age"),
                Subfield.of(f021_295_AS, 11, "AS", "Air Speed age"),
                Subfield.of(f021_295_TAS, 12, "TAS", "True Air Speed age"),
                Subfield.of(f021_295_MH, 13, "MH", "Magnetic Heading age"),
                Subfield.of(f021_295_BVR, 14, "BVR", "Barometric Vertical Rate age"),
                Subfield.fx(I021_295_FX2),
                Subfield.of(f021_295_GVR, 15, "GVR", "Geometric Vertical Rate age"),
                Subfield.of(f021_295_GV, 16, "GV", "Ground Vector age"),
                Subfield.of(f021_295_TAR, 17, "TAR", "Track Angle Rate age"),
                Subfield.of(f021_295_TID, 18, "TID", "Target Identification age"),
                Subfield.of(f021_295_TS, 19, "TS", "Target Status age"),
                Subfield.of(f021_295_MET, 20, "MET", "Met. Information age"),
                Subfield.of(f021_295_ROA, 21, "ROA", "Roll Angle age"),
                Subfield.fx(I021_295_FX3),
                Subfield.of(f021_295_ARA, 22, "ARA", "ACAS Resolution Advisory age"),
                Subfield.of(f021_295_SCC, 23, "SCC", "Surface Capabilities and Characteristics age"),
                Subfield.sp(I021_295_SP1, 24),
                Subfield.sp(I021_295_SP2, 25),
                Subfield.sp(I021_295_SP3, 26),
                Subfield.sp(I021_295_SP4, 27),
                Subfield.sp(I021_295_SP5, 28),
                Subfield.fx(I021_295_FX4));
