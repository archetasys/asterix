...
public final class Cat021V0Dot231 {
    public static final long CAT021_ID = categoryId(21, 0, 231);
    ...
    static ASTERIXCategory createCategory() {
        ...
        final DataItem i021_SP1 = DataItem.sp(CAT021_ID, 5, 10);
